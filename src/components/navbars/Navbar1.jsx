...
// Using simple SVG chevron to avoid TypeScript issues
...
export const Navbar1 = (props: Navbar1Props) => {
  ...
  return (
    <section
      id="relume"
      className="fixed top-0 left-0 right-0 z-[999] flex w-full items-center bg-background-primary lg:min-h-24 lg:px-[5%]"
    >
      <div className="w-full h-full lg:flex lg:items-center lg:justify-between container max-w-7xl mx-auto">
        <div className="flex min-h-24 items-center justify-between px-[5%] md:min-h-24 lg:min-h-full lg:px-0">
          <a href={logo.url}>
            <img src={logo.src} alt={logo.alt} style={{maxWidth: '9rem'}} />
          </a>
          <button
